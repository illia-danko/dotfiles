...
if [ "$SYSTEM_COLOR_THEME" = "dark" ]; then
    # One Dark Theme.
    export TTY_COLOR_BG0="#24292e"
    export TTY_COLOR_BG1="#2b2b2b"
    export TTY_COLOR_BG2="#181a1f"
    export TTY_COLOR_FG0="#d1d5da"
    export TTY_COLOR_FG1="#eeeeec"
    export TTY_COLOR_BLACK="#586069"
    export TTY_COLOR_RED="#ea4a5a"
    export TTY_COLOR_GREEN="#34d058"
    export TTY_COLOR_YELLOW="#ffea7f"
    export TTY_COLOR_BLUE="#2188ff"
    export TTY_COLOR_MAGENTA="#b392f0"
    export TTY_COLOR_CYAN="#39c5cf"
    export TTY_COLOR_WHITE="#d1d5da"
    export TTY_COLOR_BRIGHT_BLACK="#959da5"
    export TTY_COLOR_BRIGHT_RED="#f97583"
    export TTY_COLOR_BRIGHT_GREEN="#85e89d"
    export TTY_COLOR_BRIGHT_YELLOW="#ffea7f"
    export TTY_COLOR_BRIGHT_BLUE="#79b8ff"
    export TTY_COLOR_BRIGHT_MAGENTA="#b392f0"
    export TTY_COLOR_BRIGHT_CYAN="#56d4dd"
    export TTY_COLOR_BRIGHT_WHITE="#fafbfc"
else
    # One Light Theme.
...
"
    ...
    export FZF_PROJECTS_ROOT_DIRS="$HOME/github.com $HOME/gitlab.com $HOME/codeburg.org $HOME/.config/nvim $HOME/.local/share/nvim $HOME/bitbucket.org"
